...
@rem version name
set VERSION_NAME=compass-1.0.2
...
set distFolder=%GOPATH%\src\compass\dist
...
echo copying compass.exe
copy %GOPATH%\bin\compass.exe %distPath%

echo copying build
xcopy %GOPATH%\src\compass\build %distPath% /e/h
